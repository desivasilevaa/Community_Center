...
if ( isset( $_POST['submit'] ) ) {
	...
	$sql = "INSERT INTO Users ( first_name, last_name, username, password, email, phone) VALUES (?,?,?,?,?,?)";
	$connection->prepare($sql)->execute([$first_name, $last_name, $username, $password, $email, $phone]);
    ...
    <form method="post">
        <div class="register_form" style="margin-left: 2%;">
            <div class="col-sm-5" style="background-color: rgb(255, 255, 255); border-radius: 8px; margin-left: auto; margin-right: auto">
                <div class="row mb-3">
                    <h5 style="text-align: center;"><u>Регистрирайте се!</u></h5>
                </div>
            </div>
