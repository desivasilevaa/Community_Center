...
<html lang="en">
  ...
  <div class="card" style="width: 18rem;">
    <img src="velikdenski_koncert.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Великденски концерт</h5>
      <p class="card-text">
      Очакваме ви!<br>
      Нека заедно да споделим магията на Великден!...
<br><br><br>
      </p>
      <a href="https://www.facebook.com/photo?fbid=974917684629791&set=a.603947255060171" class="btn btn-primary">Вижте повече</a>
    </div>
  </div>
  <div class="card" style="width: 18rem;">
